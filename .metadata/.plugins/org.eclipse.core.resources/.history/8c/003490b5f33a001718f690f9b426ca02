...
public abstract class Encryptor {
	...
	public static void encrypt(String message, String pathToInput, String pathToOutput) throws Exception {
		...
		if (pathToInput.endsWith(".png")) {
			...
			if (pathToInput.endsWith(".wav")) {
				WAV_Encryptor.hideMessage(pathToInput, message, pathToOutput, PathProvider.getPathToFile2(), PathProvider.getPathToPublicKey2());
			} else {
